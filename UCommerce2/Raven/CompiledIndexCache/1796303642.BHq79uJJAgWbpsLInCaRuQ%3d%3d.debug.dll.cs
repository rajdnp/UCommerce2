...
public class Index_Products_2fByFacetsRecurse_2fda : Raven.Database.Linq.AbstractViewGenerator
{
	public Index_Products_2fByFacetsRecurse_2fda()
	{
		this.ViewText = @"docs.Products.Select(product => new {
	                                    ...
	                                    product.CategoryIds,
                                        _ = this.Recurse(product, x => x.Variants).Select(x => x.Properties[""da""].Select(z => (z.Value is string ? (IEnumerable<object>) new [] { z.Value } : (IEnumerable<object>) z.Value).Select(v => this.CreateField(LoadDocument(product.ProductDefinition).Fields.SingleOrDefault(field => field.Name == z.Key).Properties[""da""][""DisplayName""] ?? z.Key, LoadDocument(LoadDocument(product.ProductDefinition).Fields.SingleOrDefault(field => field.Name == z.Key).DataTypeId).PreValues.SingleOrDefault(preValue => preValue.Value == v).Properties[""da""][""DisplayName""] ?? v)).Where(vv => LoadDocument(product.ProductDefinition).Fields.SingleOrDefault(ff => ff.Name == z.Key).Properties[""invariant""][""Facet""]))),
                                        __ = this.Recurse(product, x => x.Variants).Select(x => x.Properties[""invariant""].Select(z => (z.Value is string ? (IEnumerable<object>) new [] { z.Value } : (IEnumerable<object>) z.Value).Select(v => this.CreateField(LoadDocument(product.ProductDefinition).Fields.SingleOrDefault(field => field.Name == z.Key).Properties[""da""][""DisplayName""] ?? z.Key, LoadDocument(LoadDocument(product.ProductDefinition).Fields.SingleOrDefault(field => field.Name == z.Key).DataTypeId).PreValues.SingleOrDefault(preValue => preValue.Value == v).Properties[""da""][""DisplayName""] ?? v)).Where(vv => LoadDocument(product.ProductDefinition).Fields.SingleOrDefault(ff => ff.Name == z.Key).Properties[""invariant""][""Facet""]))),
		...
		this.AddMapDefinition(docs => docs.Where(__document => string.Equals(__document["@metadata"]["Raven-Entity-Name"], "Products", System.StringComparison.InvariantCultureIgnoreCase)).Select((Func<dynamic, dynamic>)(product => new {
			...
			product.CategoryIds,
			_ = this.Recurse(product, (Func<dynamic, dynamic>)(x => x.Variants)).Select((Func<dynamic, dynamic>)(x => x.Properties["da"].Select((Func<dynamic, dynamic>)(z => (z.Value is string ? (IEnumerable<object>)new[] {
				z.Value
			} : (IEnumerable<object>)z.Value).Select((Func<dynamic, dynamic>)(v => this.CreateField(this.__dynamic_null != LoadDocument(product.ProductDefinition).Fields.SingleOrDefault((Func<dynamic, bool>)(field => field.Name == z.Key)).Properties["da"]["DisplayName"] ? LoadDocument(product.ProductDefinition).Fields.SingleOrDefault((Func<dynamic, bool>)(field => field.Name == z.Key)).Properties["da"]["DisplayName"] : z.Key, this.__dynamic_null != LoadDocument(LoadDocument(product.ProductDefinition).Fields.SingleOrDefault((Func<dynamic, bool>)(field => field.Name == z.Key)).DataTypeId).PreValues.SingleOrDefault((Func<dynamic, bool>)(preValue => preValue.Value == v)).Properties["da"]["DisplayName"] ? LoadDocument(LoadDocument(product.ProductDefinition).Fields.SingleOrDefault((Func<dynamic, bool>)(field => field.Name == z.Key)).DataTypeId).PreValues.SingleOrDefault((Func<dynamic, bool>)(preValue => preValue.Value == v)).Properties["da"]["DisplayName"] : v))).Where((Func<dynamic, bool>)(vv => LoadDocument(product.ProductDefinition).Fields.SingleOrDefault((Func<dynamic, bool>)(ff => ff.Name == z.Key)).Properties["invariant"]["Facet"])))))),
